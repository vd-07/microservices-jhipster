...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './dealer.reducer';
import { EntityState } from 'app/shared/reducers/reducer.utils';
import { IDealer, defaultValue } from 'app/shared/model/dealersapp/dealer.model';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DEALER_LIST actions', async () => {
    ...
    it('dispatches FETCH_DEALER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DEALER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DEALER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DEALER actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DEALER actions', async () => {
      const expectedActions = [
        {
