...
export const Dealer = (props: RouteComponentProps<{ url: string }>) => {
  const dispatch = useAppDispatch();

  const dealerList = useAppSelector(state => state.gateway.dealer.entities);
                ...
                <tr key={`entity-${i}`} data-cy="entityTable">
                  ...
                  <td className="text-end">
                    <div className="btn-group flex-btn-group-container">
                      ...
                      <Button tag={Link} to={`/dealer/${dealer.id}/edit`} color="primary" size="sm" data-cy="entityEditButton">
                        <FontAwesomeIcon icon="pencil-alt" /> <span className="d-none d-md-inline">Edit</span>
                      </Button>
                      <Button tag={Link} to={`/dealer/${dealer.id}/delete`} color="danger" size="sm" data-cy="entityDeleteButton">
