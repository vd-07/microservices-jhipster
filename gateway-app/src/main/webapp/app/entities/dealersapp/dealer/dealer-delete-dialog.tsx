...
export const DealerDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="gatewayApp.dealersappDealer.delete.question">Are you sure you want to delete this Dealer?</ModalBody>
      <ModalFooter>
